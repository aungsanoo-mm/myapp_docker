...
# --- Database Connection ---
def get_db():
    # Docker ထဲက Postgres နဲ့ ချိတ်ဆက်ခြင်း
    return psycopg2.connect(
        os.environ.get("DATABASE_URL"), 
        cursor_factory=psycopg2.extras.DictCursor
    )

# Table မရှိသေးရင် အလိုအလျောက် ဆောက်ပေးမည့် Function
def init_db():
    try:
        conn = get_db()
        cur = conn.cursor()
...
# App စတင်ချိန်မှာ Table ဆောက်ပေးရန် ခေါ်ခြင်း
init_db()
